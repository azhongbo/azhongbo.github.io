...
chkData(`
##### (data_system.js) apt - proxy socks5 #####
## Linux Server
vi /etc/tsocks.conf
server = 10.12.25.5
server_port = 3128
...
chkData(`
##### (data_system.js) PostgreSQL install #####
## 安裝
...
chkData(`
##### (data_system.js) firewall iptable #####
#### Firewall ############################################################
...
chkData(`
##### (data_system.js) firewall iptable2 #####
iptables -P INPUT ACCEPT
iptables -P FORWARD ACCEPT
iptables -P OUTPUT ACCEPT
iptables -t nat -F
...
chkData(`
##### (data_system.js) ubuntu vino vnc setup #####
# set for windows vnc
...
chkData(`
##### (data_system.js) sudo without passwd 免密碼 #####
visudo
## 最後一行加入
...
chkData(`
##### (data_system.js) Ubuntu path 系統路徑 #####
...
chkData(`
##### (data_system.js) Linux find copy 檔案 #####
## 搜尋和複製檔案
...
chkData(`
##### (data_system.js) Windows Firewall #####
...
chkData(`
##### (data_system.js) ffmpeg mp4 影片裁切.py  #####
...
chkData(`
##### (data_system.js) ubuntu nvidia gpu cuda tf pytorch 安裝 #####
##### 安裝顯示卡 ##################################################
...
chkData(`
##### (data_system.js) Text OCR 文字辨識 安裝 Tesseract #####
# 安裝 Tesseract 4.x
...
chkData(`
##### (data_system.js) qemu androix-x86 #####
...
chkData(`
##### (data_system.js) Jitsi Meeting Linux 安裝 #####

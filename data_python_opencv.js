...
chkData(`
##### (data_python_opencv.js) Text 文件掃描-可調對比亮度 #####
...
chkData(`
##### (data_python_opencv.js) Text 文件掃描 #####
...
chkData(`
##### (data_python_opencv.js) OCR 文字辨識 #####
...
chkData(`
##### (data_python_opencv.js) 邊緣檢測-強化去雜訊 #####
...
chkData(`
##### (data_python_opencv.js) 邊緣檢測強化版-可調亮度對比 #####
...
chkData(`
##### (data_python_opencv.js) 邊緣檢測-標示面積 #####
...
chkData(`
##### (data_python_opencv.js) HSV mask 去背 #####
...
chkData(`
##### (data_python_opencv.js) 擷取 撲克牌-區塊 轉正 #####
...
chkData(`
##### (data_python_opencv.js) 基本-劃線 寫字 劃圈  #####
...
chkData(`
##### (data_python_opencv.js) 濾鏡-灰階,高斯模糊,邊緣檢測 #####
...
chkData(`
##### (data_python_opencv.js) cv2 人臉辨識 Video #####
...
chkData(`
##### (data_python_opencv.js) cv2 人臉辨識 #####
...
chkData(`
##### (data_python_opencv.js) cv2 圖片操作 #####
...
chkData(`
##### (data_python_opencv.js) 副程式-堆疊顯示圖片 #####

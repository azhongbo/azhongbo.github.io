...
// chkData(`
// ##### (data_tf_dnn.js) Tensorflow DNN 主旨放這裡 #####
// 內容放這裡
// `)
...
chkData(`
##### (data_tf_dnn.js) Tensorflow DNN cifar10 #####
...
chkData(`
##### (data_tf_dnn.js) Tensorflow DNN mnist 使用 Tensorboard #####
...
chkData(`
##### (data_tf_dnn.js) Tensorflow DNN  mushroom 蘑菇 #####
...
chkData(`
##### (data_tf_dnn.js) Tensorflow DNN mnist #####
...
chkData(`
##### (data_tf_dnn.js) Tensorflow NN mnist #####
